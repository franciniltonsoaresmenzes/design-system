...
export function SignIn() {
  const [isUserSingIn, setUserSignIn] = useState(false)
  ...
  return (
    <div className='w-screen h-screen bg-gray-900 flex items-center flex-col justify-center text-gray-100'>
      ...
      <form onSubmit={handleSingIn} className='flex flex-col items-stretch w-full gap-4 max-w-[400px] mt-10 '>
        {isUserSingIn && <Text>Login realizado!</Text>}
        ...
        <label htmlFor="email" className='flex flex-col gap-3' >
          ...
          <TextInput.Root>
            <TextInput.Icon>
              ...
              <TextInput.Input id="email" type="" placeholder='Digite seu e-mail' />
          </TextInput.Root>
        </label>
        ...
        <label htmlFor="remember" className='flex items-center gap-2' >
          ...
          <Text size='lg' className='text-gray-200' >Lembrar de mim por 30 dias</Text>
        </label>
